      ...
      <div className='w-[92%] flex-col shadd rounded-2xl overflow-hidden h-[92%] bg-[#dfdfdf] flex'>
        <div className='h-[8%] md:h-[10%] bg-[#284785] flex justify-between items-center'>
          ...
          <div onClick={()=>{
            setmobile(false)
            setperson("PR1")
          }} className='cursor-pointer pl-2 pr-5 md:hidden text-white text-2xl'>👈🏼</div>
        ...
        <div className='flex w-[100%] h-[92%] md:h-[90%]'>
          <div className={`${burger?'block':'hidden'} absolute right-[4%] overflow-hidden rounded-xl bg-white w-[200px]`}>
            <button onClick={()=>{
              setaddperson(true)
              setburger(false)
